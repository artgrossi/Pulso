...
export function SidebarNav() {
  ...
  return (
    <aside className="hidden sm:flex sm:w-56 sm:flex-col sm:border-r sm:border-gray-800/50 sm:bg-gray-950/50">
      {/* Logo */}
      ...
      <div className="border-t border-gray-800/50 px-3 py-4">
        <form action="/auth/signout" method="post">
          <button
            type="submit"
            className="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm text-gray-500 transition-colors hover:bg-gray-800/50 hover:text-gray-300"
          >
            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
